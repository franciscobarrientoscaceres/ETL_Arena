...
- [ ] 13.4 Implementar golden tests en `tests/golden/`
    ...
    - NOTA septiembre 2026: verificar el lunes la discrepancia entre `c12=1975` (contador de RawData-PCS en C12) y `annual_ava_snapshot.sampling_blocks=1977` (celda vinculada de Annual_AVA). Actualizar el golden con el valor correcto tras la corrida completa del mes.
