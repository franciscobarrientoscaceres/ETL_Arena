...
description: Especialista SQL Server del ETL Arena: DDL, seeds, vistas, roles, índices columnstore y rendimiento de carga. Usar para las tareas de tasks.md asignadas a database-optimizer.
---
